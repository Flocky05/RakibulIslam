    ...
    return (
        <div className="absolute grid grid-cols-3 gap-20 p-10 bg-black">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 justify-between text-white p-4 gap-4">
                    <p className="bg-green-600 px-4 py-2 rounded-md">live</p>
                    <p className="bg-red-300 px-4 py-2 rounded-md">Github</p>
                </div>
            </div>
            <div>
                <div className="overflow-hidden rounded-lg">
            ...
            <div>
                <div className="overflow-hidden rounded-lg">
                    <img className="object-cover object-top hover:object-bottom h-80 w-full ease-out duration-1000" src={img11} alt="" />
                </div>
                <div className="grid grid-cols-2 justify-between text-white p-4 gap-4">
                    <p className="bg-green-600 px-4 py-2 rounded-md">live</p>
                    <p className="bg-red-300 px-4 py-2 rounded-md">Github</p>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 justify-between text-white p-4 gap-4">
                    <p className="bg-green-600 px-4 py-2 rounded-md">live</p>
                    <p className="bg-blue-300 px-4 py-2 rounded-md">Github</p>
                </div>
            </div>
        </div>
    );
